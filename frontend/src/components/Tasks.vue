<template>
          ...
          <div v-if="showHabitForm" class="form-container card2">
            <form @submit.prevent="submitHabit">
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" v-model="HabitForm.title" placeholder="Enter title" aria-label="Title" aria-describedby="basic-addon1" required>
              </div>
              <div class="form-floating">
              <textarea v-model="HabitForm.description" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" required></textarea>
              ...
              <div class="form-buttons">
                ...
                <button type="button" class="btn btn-danger" @click="cancelHabitForm">Cancel</button>
              </div>
            </form>
          </div>

          <div class="card brown-card">
            <div v-for="h in habits" :key="h.title" class="card2 d-flex align-items-center justify-content-between">
  <div class="habit-controls d-flex align-items-center">
    <!-- Minus Button -->
    <button class="btn btn-outline-danger btn-circle" @click="decreaseCount(h)" :disabled="h.count <= 0">
      <i>-</i>
    </button>
    ...
    <div class="habit-content mx-3">
      ...
      <div style="color: black;"><strong class="cardtext">Count:</strong>{{ h.count }}</div>
    </div>
  ...
  <!-- Delete Habit Button -->
  <button class="btn btn-danger btn-sm" @click="markAsDoneh(h)">
    Delete Habit
  </button>
</div>
        ...
        <div class="col-12 col-sm-6 col-md-3 card-section">
          ...
          <div v-if="showLTForm" class="form-container card2">
            <form @submit.prevent="submitLT">
              <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1">Title</span>
                <input type="text" class="form-control" v-model="LTForm.title" placeholder="Enter title" aria-label="Title" aria-describedby="basic-addon1" required>
              </div>
              <div class="form-floating">
              <textarea v-model="LTForm.description" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" required></textarea>
              <label for="floatingTextarea2">Enter Description</label>
              </div>
              <div>&nbsp;</div>
          ...
          <div class="card brown-card">
            <div v-for="lt in longTermTasks" :key="lt.title" class="card2">
              ...
              <div><small class="cardtext"><strong class="cardtext">Due:</strong> {{ lt.duedate }}</small></div>
              <div><button class="btn btn-success btn-sm" @click="markAsDonelt(lt)">Mark as Done</button></div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-md-3 card-section">
          ...
          <div v-if="showToDoForm" class="form-container card2">
            <form @submit.prevent="submitToDo">
              <div class="input-group mb-3">
                <span class="input-group-text" id="basic-addon1">Title</span>
                <input type="text" class="form-control" v-model="todoForm.title" placeholder="Enter title" aria-label="Title" aria-describedby="basic-addon1" required>
              </div>
              <div class="form-floating">
              <textarea v-model="todoForm.description" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" required></textarea>
              <label for="floatingTextarea2">Enter Description</label>
              </div>
              <div>&nbsp;</div>
          ...
          <div class="card brown-card">
            <div v-for="todo in todos" :key="todo.title" class="card2">
              ...
              <div><button class="btn btn-success btn-sm" @click="markAsDone(todo)">Mark as Done</button></div>
            </div>
          </div>
        </div>
...
export default {
  ...
  .catch(error => {
    ...
    submitLT() {
      ...
      axios.post('http://localhost:8000/api/lts', {
