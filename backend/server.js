...
app.delete('/api/user_habits', async (req, res) => {
    ...
    try {
      ...
      const result = await Habit.deleteOne({ _id: id, username: username, title: title });
...
app.post("/api/habits", async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ message: "Habit created successfully", habit: savedHabit });
    } catch (error) {
...
app.put('/api/habits/:id', async (req, res) => {
    ...
    try {
      const habit = await Habit.findByIdAndUpdate(id, { count: count }, { new: true });
      res.json(habit);
    } catch (error) {
...
app.delete('/api/user_lts', async (req, res) => {
    ...
    try {
      // Query MongoDB to delete the todo with the given username, title, and _id
      const result = await LT.deleteOne({ _id: id, username: username, title: title });
...
app.delete('/api/user_todos', async (req, res) => {
    ...
    try {
      // Query MongoDB to delete the todo with the given username, title, and _id
      const result = await ToDo.deleteOne({ _id: id, username: username, title: title });
...
app.post("/api/todos", async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ message: "To-Do created successfully", todo: savedToDo });
    } catch (error) {
